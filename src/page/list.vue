        ...
        methods: {
          ...
          queryList(val){
            this.$get("/data/my", {
              ...
              pageNum:1,//当前页码
              pageSize:20,//每页显示得条数
              accessToken: 'eyJhbGciOiJIUzI1NiJ9..D19GR9AQH271s66hfQzBgAOkJWP0Y-cNBq4ccOHXXyw'
            }).then(res => {
              if (res.state === 0) {
